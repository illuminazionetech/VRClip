package com.illuminazionetech.vrclip.ui.page.settings.general
...
import com.illuminazionetech.vrclip.util.DISABLE_PREVIEW
import com.illuminazionetech.vrclip.util.DOWNLOAD_ARCHIVE
import com.illuminazionetech.vrclip.util.FileUtil.getArchiveFile
import com.illuminazionetech.vrclip.util.NOTIFICATION
    ...
    Scaffold(
        ...
        content = {
            ...
            LazyColumn(modifier = Modifier, contentPadding = it) {
                ...
                item { PreferenceSubtitle(text = stringResource(R.string.vr_and_3d)) }
