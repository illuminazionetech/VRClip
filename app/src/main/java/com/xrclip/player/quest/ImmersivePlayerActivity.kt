package com.xrclip.player.quest
...
import com.xrclip.R
import com.xrclip.player.ProjectionDetector
 ...
 * launched by [com.xrclip.player.PlayerLauncher] instead of the flat-panel [com.xrclip.player.PlayerScreen]
...
class ImmersivePlayerActivity : AppSystemActivity() {
    ...
    companion object {
        const val EXTRA_VIDEO_ID = "com.xrclip.player.quest.EXTRA_VIDEO_ID"
        const val EXTRA_VIDEO_PATH = "com.xrclip.player.quest.EXTRA_VIDEO_PATH"
        const val EXTRA_PROJECTION = "com.xrclip.player.quest.EXTRA_PROJECTION"
    }
}
