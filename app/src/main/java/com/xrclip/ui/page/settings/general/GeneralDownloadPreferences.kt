package com.xrclip.ui.page.settings.general
...
import com.xrclip.util.DOWNLOAD_ARCHIVE
import com.xrclip.util.FileUtil.getArchiveFile
import com.xrclip.util.NOTIFICATION
import com.xrclip.util.NotificationUtil
import com.xrclip.util.PLAYLIST
import com.xrclip.util.PRIVATE_MODE
import com.xrclip.util.VR_MODE
    ...
    Scaffold(
        ...
        content = {
            ...
            LazyColumn(modifier = Modifier, contentPadding = it) {
                ...
                item { PreferenceSubtitle(text = "VR & 3D") }

                item {
                    var vrMode by remember { mutableStateOf(VR_MODE.getBoolean()) }
                    PreferenceSwitch(
                        ...
                        onClick = {
                            vrMode = !vrMode
                            PreferenceUtil.updateValue(VR_MODE, vrMode)
                        },
                    )
                }
