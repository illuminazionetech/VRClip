...
import com.xrclip.R
import com.xrclip.database.backup.BackupUtil.BackupDestination
import com.xrclip.database.backup.BackupUtil.BackupType
import com.xrclip.ui.component.DialogSubtitle
import com.xrclip.ui.component.XRClipDialog
import com.xrclip.ui.component.SingleSelectChip
...
private fun PreviewExport() {
    XRClipTheme { ExportDialog() { _, _ -> } }
}

@Preview(uiMode = Configuration.UI_MODE_NIGHT_YES, name = "Dark")
@Composable
private fun PreviewImport() {
    XRClipTheme { ImportDialog() { _ -> } }
}
